...
namespace AuthEg.Controllers
{
    public class EmployeeController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EId,Ename,Salary,DOB,DeptId")] tbl_Emp tbl_Emp)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EId,Ename,Salary,DOB,DeptId")] tbl_Emp tbl_Emp)
        {
            if (ModelState.IsValid)
            {
